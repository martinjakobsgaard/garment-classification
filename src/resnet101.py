...
train_im = tf.keras.applications.resnet.preprocess_input(train_im)
    #resnet101.preprocess_input(train_im)
...
# Source: https://keras.io/api/applications/resnet/#resnet101-function
#res_model = K.applications.ResNet50(include_top=True, weights="imagenet")
res_model = K.applications.ResNet101(include_top=False, weights="imagenet", input_tensor=input_shape, pooling=max, classes=setting_class_count) # <- Good input
...
check_point = K.callbacks.ModelCheckpoint(filepath="../models/resnet101" + export_suffix + "-checkpoint.h5",
...
# Export model
model_export_name = "../models/resnet101" + export_suffix + ".h5"
