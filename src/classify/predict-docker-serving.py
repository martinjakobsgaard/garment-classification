...
def load_image(filename):
    ...
    print("============================")
    print("input size: ", input_arr.size)
    print("input shape: ", input_arr.shape)
    print("len(x): ", len(input_arr.tolist()))
    print("len(x[0]): ", len(input_arr.tolist()[0]))
    print("len(x[0][0]): ", len(input_arr.tolist()[0][0]))
    print("len(x[0][0][0]): ", len(input_arr.tolist()[0][0][0]))
