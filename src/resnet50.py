...
train_lab_categorical = tf.keras.utils.to_categorical(train_lab, num_classes=2, dtype='uint8')
...
check_point = K.callbacks.ModelCheckpoint(filepath="../models/resnet50-checkpoint.h5",
